...
module.exports = {
  content: [
    "./src/**/*.{html,ts}", // procura classes no Angular
  ],
  theme: {
    extend: {
      fontFamily: {
        ...
        space: ['Space Grotesk', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'Noto Sans', 'sans-serif', 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'],
